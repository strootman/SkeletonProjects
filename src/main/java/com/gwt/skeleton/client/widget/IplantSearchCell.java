 ...
 * 
 */
public class IplantSearchCell extends TriggerFieldCell<String> implements HasExpandHandlers, HasCollapseHandlers {

    public interface IplantSearchCellAppearance extends TriggerFieldAppearance {
     ...
     */
    public IplantSearchCell() {
        this(GWT.<IplantSearchCellAppearance> create(IplantSearchCellAppearance.class));
    }
     ...
     */
    public IplantSearchCell(IplantSearchCellAppearance appearance) {
        super(appearance);
    ...
    protected boolean isFocusClick(XElement parent, XElement target) {
        // boolean result = parent.isOrHasChild(target) || (menu != null &&
        // (menu.getElement().isOrHasChild(target) ||
        // menu.getDatePicker().getElement().isOrHasChild(target)));
